...
const ContactEditor = () => {
  ...
  const uploadButton = (
    <button style={{ border: 0, background: 'none' }} type="button">
      {loading ? <LoadingOutlined onPointerOverCapture={undefined} onPointerMoveCapture={undefined}
                                  onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} /> : <PlusOutlined
          onPointerOverCapture={undefined} onPointerMoveCapture={undefined} onPointerEnterCapture={undefined}
