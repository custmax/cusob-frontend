        ...
        <div className={`flex flex-col items-center ${theme === 'dark' ? 'bg-[#0b0121]' : 'bg-[#ffffff]'}`}>
            ...
            <div className="grid grid-cols-3 gap-x-2 mt-10 mb-20">
                <div className="flex flex-col items-center">
                    <img src="/temp_imgs/shared_component/customer_comments/comment_3.png" alt="Image 1"
                         className="rounded-lg mb-2 w-[350px] h-[400px]"/>
                </div>
                <div className="flex flex-col items-center">
                    <img src="/temp_imgs/shared_component/customer_comments/comment_2.png" alt="Image 2"
                         className="rounded-lg mb-2 w-[350px] h-[400px]"/>
                </div>
                <div className="flex flex-col items-center">
                    <img src="/temp_imgs/shared_component/customer_comments/comment_1.png" alt="Image 3"
                         className="rounded-lg mb-2 w-[350px] h-[400px]"/>
                </div>
            </div>
        </div>
