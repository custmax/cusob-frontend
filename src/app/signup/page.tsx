            ...
            <div className={down}>
                <div className={content}>
                    ...
                    <div>
                        ...
                        <p className={details1}>By clicking "Sign up now" , you agree to the <Link href="/terms"
                                                                                                   style={{textDecoration: 'none'}}>Terms
                            of
                        ...
                        <p className={sign}>Already have an account?<Link href="/login"
